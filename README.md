...
| Auto.cfg 编辑器 | 可视化编辑全局 cfg 的 auto.cfg，开关/滑块/输入框分组展示，支持从模板创建 |
...
│  │  ├─ cfg_parser.rs            # auto.cfg 解析/序列化、section/entry 结构化
...
| 版本 | 重点 |
| --- | --- |
| `v2.2.0` | Auto.cfg 可视化编辑器（开关/滑块/输入框分组编辑、模板创建、原始视图） |
